...
export const metadata: Metadata = {
  title: "HIPAA Notice — NexaCare Management",
  description: "HIPAA Notice of Privacy Practices for NexaCare Management, LLC.",
};
  ...
  return (
    <main className="pt-16" style={{ backgroundColor: "#f8f7f5", minHeight: "100vh" }}>
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-24">
        <p className="eyebrow mb-4">HIPAA NOTICE</p>
        <h1
          className="mb-6"
          style={{
        ...
        >
          ...
          <p className="text-[15px] leading-relaxed" style={{ color: "#555" }}>
            ...
            for our current hipaa notice practices.
          </p>
        </div>
      </div>
    </main>
