          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              >
                ...
                <p className="text-[12px] font-mono mb-4" style={{ color: "#777" }}>
                  Policy {policy.policy}
                </p>

                <div
                  className="space-y-2 mb-4 pt-4"
